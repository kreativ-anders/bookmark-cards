      ...
      <div class="column is-8">
        <div class="columns">
          ...
          <div class="column">
            ...
            <h3 class="title is-2 is-spaced">10€ <small class="has-text-grey">/ year</small></h3>
            <p class="subtitle">You like Bookmark.cards? Awesome!</p>
            <p>(You can switch your plan interval <br />after monthly initialisation.)</p>
          </div>
        </div>
      </div>
    </div>
