          ...
          <footer>  
            <div class="grid card-grid">
              ...
              <?php if (
                ...
                ?>
                <button class="edit" data-target="changeModal"  title="Edit Bookmark" data-pirsch-event="Update Bookmark" onclick="<?= htmlspecialchars($onclick, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?>">
