          ...
          <footer>  
            <div class="grid card-grid">
              ...
              <?php if (
                ...
                <button class="edit" data-target="changeModal"  title="Edit Bookmark" onclick="changeData('<?= $i ?>','<?= $bookmark['title'] ?>', '<?= htmlspecialchars($bookmark['link']) ?>', '<?= $bookmark['tags'] ?>'); toggleModal(event);">
              ...
              <form action="" method="POST">
                ...
                <button class="delete" type="submit" title="Delete Bookmark">
