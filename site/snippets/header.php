  ...
  <header>
    <nav role="navigation" aria-label="main navigation">
      ...
      <ul>
        <?php  if(!$kirby->user()): ?>
        <li>
          <button id="login" class="contrast outline" data-target="loginModal" data-pirsch-event="Open Login Modal" onclick="toggleModal(event)">Login</button>
        </li>  
        <li>
          <button id="register" data-target="registerModal" data-pirsch-event="Open Register Modal" onclick="toggleModal(event)"><strong>Register</strong></button>
        </li>
        <?php endif; ?>
        ...
        <li>
          <button id="user" title="User Settings" class="secondary outline" data-target="userModal" data-pirsch-event="Open User Settings Modal" onclick="toggleModal(event)">
